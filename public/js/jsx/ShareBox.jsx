class ShareBox extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {data: [], showShareBox: true};
    }
                ...
                <form method="post" action="/api/content/" encType="multipart/form-data">
                    <div className="row">
                        ...
                        <div className="col-md-11">
                            <textarea id="share_area" ref="share_area" placeholder="" name="content" rows="3"
                            ...
                            <div className="row preview video">
                                <div className="col-md-12">
                                    ...
                                    <div id="video_target" className="embed-responsive embed-responsive-16by9"
                                         dangerouslySetInnerHTML={{__html: this.state.data.html}}></div>
                                </div>
                        ...
                        <div className="col-md-5">
                            ...
                            <button className="btn btn-lg btn-info "><i
                                className="glyphicon glyphicon-heart"></i> Share!
                            </button>
